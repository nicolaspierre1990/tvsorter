...
internal class TvShowsController(
    IStorageProvider storageProvider,
    ITvShowRepository tvShowRepository,
    IScanManager scanManager) : ControllerBase
{
    /// <summary>
    ///     The scan manager.
    /// </summary>
    ...
    /// </summary>
    private readonly ITvShowRepository tvShowRepository = tvShowRepository;
    ...
    public override void Initialise(IView view)
    {
        ...
        Shows = new BindingList<TvShow>(tvShowRepository.GetTvShows().OrderBy(x => x.Name).ToList());
    ...
    ///     The arguments of the event.
    /// </param>
    private void OnTvShowRemoved(object sender, TvShowEventArgs e) => Shows.Remove(e.TvShow);
    ...
    private void OnSettingsChanged(object sender, EventArgs e) => DestinationDirectories = new BindingList<string>(settings.DestinationDirectories);
}
