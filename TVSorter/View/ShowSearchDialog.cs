...
public partial class ShowSearchDialog : Form, IView
{
    ...
    ///     The arguments of the event.
    /// </param>
    private void SearchButtonClick(object sender, EventArgs e) => controller.Search(nameText.Text);
    ...
    ///     The arguments of the event.
    /// </param>
    private void ShowSearchDialogLoad(object sender, EventArgs e) => controller.Initialise(this);


    /// <summary>
    /// Handles the SelectedIndexChanged event of the listResults control.
    /// </summary>
