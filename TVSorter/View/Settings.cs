...
public partial class Settings : UserControl, IView
{
    ...
    private void EditOverwriteKeywordsButtonClick(object sender, EventArgs e)
    {
        ...
        {
            overwriteKeywords = [.. listController.List];
        }
    }
    ...
    private void FileExtensionsButtonClick(object sender, EventArgs e)
    {
        ...
        if (dialog.ShowDialog(this) == DialogResult.OK)
        {
            fileExtensions = [.. listController.List];
        }
    }
    ...
    private void RegExButtonClick(object sender, EventArgs e)
    {
        ...
        if (dialog.ShowDialog(this) == DialogResult.OK)
        {
            regularExpressions = [.. listController.List];
        }
    }
    ...
    ///     The arguments of the event.
    /// </param>
    private void RevertButtonClick(object sender, EventArgs e) => controller.Revert();
    ...
    {
        controller.Settings.RegularExpressions = [.. regularExpressions];
        controller.Settings.FileExtensions = [.. fileExtensions];
        controller.Settings.DestinationDirectories = [.. destinationDirectories];
        controller.Settings.IgnoredDirectories = [.. ignoredDirectories];
        controller.Settings.OverwriteKeywords = [.. overwriteKeywords];
        ...
        MessageBox.Show("Settings were updated", "Notification", MessageBoxButtons.OK, MessageBoxIcon.Information);
    }
