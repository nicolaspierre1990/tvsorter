...
public class FileManagerTests : ManagerTestBase
{
    ...
    public FileManagerTests()
    {
        ...
        fileManager = new FileManager(StorageProvider, scanManager, fileResultManager);
    }
    ...
    public void FileCopyMove()
    {
        ...
        Root.GetFile(Arg.Any<string>())
            .Returns(
                x =>
                {
                    ...
                    path.Should().Be(expectedPath, "The path is incorrect.");
        ...
        seasonOne.Should().NotBeNull("The Season One folder should have been created.");
