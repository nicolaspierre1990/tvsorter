...
public abstract class ManagerTestBase
{
    ...
    ///     The directory info.
    /// </returns>
    protected static IDirectoryInfo[] CreateTestDirectory(IDirectoryInfo parent, params string[] names)
    {
    ...
    /// </returns>
    protected static IFileInfo[] CreateTestFile(IDirectoryInfo directory, params string[] names)
    {
        ...
        for (var i = 0; i < names.Length; i++)
        {
            ...
            file.Extension.Returns(names[i][names[i].LastIndexOf('.')..]);
