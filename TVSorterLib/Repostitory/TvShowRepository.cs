...
public class TvShowRepository : ITvShowRepository
{
    ...
    /// </returns>
    public IEnumerable<TvShow> GetTvShows() => storageProvider.LoadTvShows();
    ...
    /// </param>
    private void OnTvShowAdded(object sender, TvShowEventArgs e) => TvShowAdded?.Invoke(sender, e);
    ...
    ///     The arguments of the event.
    /// </param>
    private void OnTvShowChanged(object sender, TvShowEventArgs e) => TvShowChanged?.Invoke(sender, e);
