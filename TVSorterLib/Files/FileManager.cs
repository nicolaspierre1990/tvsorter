    ...
    : IFileManager
{
    ...
    ///     The file result manager.
    /// </summary>
    private readonly IFileResultManager fileResultManager = fileResultManager;
    ...
    ///     The settings.
    /// </summary>
    private readonly Settings settings = storageProvider.Settings;
    ...
    private void DeleteEmptySubdirectories(FileResult file)
    {
        ...
        if (file.InputFile.Directory != null &&
            file.InputFile.Directory.GetFiles().Length == 0 &&
            file.InputFile.Directory.GetDirectories().Length == 0)
        {
