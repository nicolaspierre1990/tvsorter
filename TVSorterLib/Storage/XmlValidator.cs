...
public class XmlValidator(ITextReaderProvider textReaderProvider) : IXmlValidator
{
    /// <summary>
    ...
    private readonly ITextReaderProvider textReaderProvider = textReaderProvider;
    ...
    private static string GetFileName(int schemaVersion)
    {
