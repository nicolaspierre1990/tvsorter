...
public class XmlMigration(IEnumerable<IStorageMigration> storageMigrations, IXmlValidator xmlValidator) : IXmlMigration
{
    internal const int XmlVersion = 5;

    private readonly IEnumerable<IStorageMigration> storageMigrations = storageMigrations;
    private readonly IXmlValidator xmlValidator = xmlValidator;
    ...
    /// </param>
    private static void SanitizeXml(XElement root)
    {
