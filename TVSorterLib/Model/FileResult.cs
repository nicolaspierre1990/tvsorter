...
public class FileResult
{
    ...
    /// </returns>
    internal bool ContainsKeyword(IEnumerable<string> keywords) => keywords.Any(keyword => InputFile.Name.Contains(keyword, StringComparison.InvariantCultureIgnoreCase));
}
